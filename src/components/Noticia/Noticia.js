                    ...
                    {noticia && (
                        <div className=" card medium" >
                            ...
                            <div className="card-content" >
                                <span className="card-title activator grey-text text-darken-4">{noticia.title}<i className="material-icons right">more_vert</i>
                                     </span>
                            </div>

                            <div className="card-reveal">
                                <span className="card-title grey-text text-darken-4">{noticia.title}<i className="material-icons right">close</i></span>
